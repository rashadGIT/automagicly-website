...
// Email-based rejection endpoint with Supabase
// URL: /api/reviews/reject?token=xxx
...
export async function GET(request: NextRequest) {
    ...
    return new NextResponse(
      `<html>
        ...
        <body style="font-family: Arial; text-align: center; padding: 50px;">
          <h1 style="color: #dc2626;">❌ Invalid Rejection Link</h1>
  ...
  try {
      ...
      return new NextResponse(
        `<html>
          ...
          <body style="font-family: Arial; text-align: center; padding: 50px;">
            ...
            <p>This rejection link has expired (7 days maximum).</p>
            <a href="/admin/reviews" style="color: #2563eb;">Go to Admin Dashboard</a>
          </body>
        </html>`,
    ...
    // Update review to rejected and clear token
    ...
    return new NextResponse(
      `<html>
        ...
        <body style="font-family: Arial, sans-serif; text-align: center; padding: 50px; background: linear-gradient(135deg, #f59e0b 0%, #dc2626 100%); min-height: 100vh; display: flex; align-items: center; justify-content: center; margin: 0;">
          <div style="background: white; padding: 40px; border-radius: 20px; box-shadow: 0 20px 60px rgba(0,0,0,0.3); max-width: 500px;">
            ...
            <h1 style="color: #dc2626; margin-bottom: 10px;">Review Rejected</h1>
            <p style="color: #6b7280; font-size: 18px; margin-bottom: 30px;">
              The review from <strong>${review.name || 'Anonymous'}</strong> has been rejected and will not appear on your website.
            </p>
    ...
    return new NextResponse(
      `<html>
        ...
        <body style="font-family: Arial; text-align: center; padding: 50px;">
          ...
          <p>Failed to reject review. Please try again or contact support.</p>
          <a href="/admin/reviews" style="color: #2563eb;">Go to Admin Dashboard</a>
        </body>
      </html>`,
